...
| `full_volatility_clustering_has_decay` | `0.17859447200796197` | `0.03` | 85.0% | 20261104, 20261107, 20261113 |
...
| `agent_information_marginal_response` | `1.3954798681488314` | `1.0` | 95.0% | 20261104 |
| `agent_information_independent_response` | `1.1672738318898115` | `1.0` | 95.0% | 20261119 |
...
| `noise_only_remains_active` | `0.08880020379499659` | `0.003` | 100.0% | none |
...
| `noise_only_avoids_pathological_return_predictability` | `0.09782454089864595` | `0.25` | 100.0% | none |
...
| `liquidity_stress_avoids_pathological_return_predictability` | `0.12145845651179682` | `0.25` | 100.0% | none |
| `spread_and_depth_are_finite` | `6.881973817117615` | `{"maximum": 25.0, "minimum": 1.0}` | 100.0% | none |
| `liquidity_stress_increases_clustering` | `0.1242140246599544` | `0.0` | 100.0% | none |
...
|---|---:|---:|---:|---:|---:|---:|
| full | 0.017447 | -0.020965 | 0.178594 | 2.138539 | 0.391644 | 0.019019 |
| no_direct_news | 0.019171 | -0.000973 | 0.568320 | 14.353740 | 0.737012 | 0.296553 |
| no_agent_information | 0.016966 | 0.016959 | 0.179601 | 2.947028 | 0.382919 | 0.032062 |
| no_information_channels | 0.019886 | -0.004157 | 0.572916 | 15.133074 | 0.744733 | 0.344638 |
...
| noise_only | 0.088800 | 0.097825 | 0.711721 | 3.540757 | 0.792021 | 3.328022 |
| no_logit | 0.017447 | -0.020965 | 0.178594 | 2.138539 | 0.391644 | 0.019019 |
| no_activity_persistence | 0.017453 | -0.016985 | 0.174830 | 1.945551 | 0.376901 | 0.019053 |
| independent_signals | 0.012015 | -0.034380 | -0.003868 | -0.002953 | 0.041215 | 0.018473 |
| fixed_participation | 0.018093 | -0.055397 | 0.130526 | 1.322928 | 0.340528 | 0.021616 |
| fixed_liquidity | 0.014891 | -0.020726 | 0.065666 | 0.209715 | 0.203083 | 0.018517 |
| liquidity_stress | 0.035944 | -0.121458 | 0.315528 | 3.059648 | 0.536451 | 0.032882 |
| concentrated_wealth | 0.017130 | -0.030860 | 0.206791 | 2.014446 | 0.386929 | 0.020094 |
| garch_t_control | 0.017036 | -0.036368 | 0.313324 | 6.461395 | 0.503466 | 0.021264 |
| logit_learning | 0.020179 | -0.000462 | 0.213544 | 2.577256 | 0.440915 | 0.036878 |
...
| Absolute-return ACF(5) | 0.179106 |
| Absolute-return ACF(20) | 0.056471 |
| Absolute-return ACF(50) | -0.028534 |
| Volume ACF(1) | 0.844973 |
| OFI ACF(1) | 0.429881 |
